...
| AGT-S-08 | Execution retry không được mở rộng task/file boundary, frozen contract, profile binding, exact command, checkpoint hoặc chạm material/cross-contract work nếu chưa có Human checkpoint persisted. |
